(() => {
  ...
  const EN = {
    ...
    tickerTitle:'Daily Top IBs', tickerNote:'Historical rebate records', heroKicker:'INDEPENDENT REBATE SERVICE', heroTitle:'Trade as usual.\nGet the rebate back.', heroDesc:'Max Rebate returns 100% of the eligible rebate we receive for the client. No extra rebate cut. No added spread markup. Your platform trading conditions stay unchanged.',
  ...
  const ZHT = {
    ...EN,
    brandSub:'滿返網', apply:'提交申請', navRebate:'甚麼是返佣', navPlatforms:'合作平台', navRates:'返佣標準', navCalc:'計算器', navContact:'聯絡', tickerTitle:'每日 Top IB', tickerNote:'歷史返佣表現', heroTitle:'交易照常，\n返佣回來。', heroDesc:'滿返網把我們收到的合資格返佣 100% 返還給客戶。不額外克扣，不額外加點差；交易條件保持平台原樣。', viewRates:'查看返佣標準', applyNow:'立即申請', metric1:'返還我們收到的合資格返佣，不額外抽成', metricPer:'/手', metric2:'TMGM 標準帳戶 · 黃金返佣', metric3:'額外點差加價',
