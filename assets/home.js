(() => {
  ...
  const EN = {
    brandSub:'TRADING CASHBACK', apply:'Apply', navRebate:'What is a rebate?', navPlatforms:'Platforms', navRates:'Rebate rates', navCalc:'Calculator', navContact:'Contact',
    tickerTitle:'Daily Top IBs', tickerNote:'Historical rebate records', heroKicker:'INDEPENDENT REBATE SERVICE', heroTitle:'Trade as usual.\nGet the rebate back.', heroDesc:'Max Rebate returns 100% of the eligible rebates we receive to clients. No extra deduction and no added spread markup. Trading conditions remain unchanged, while traders receive extra cashback. We are committed to optimizing trading costs as much as possible.',
    viewRates:'View rebate rates', applyNow:'Apply now', metric1:'of eligible rebate received is returned', metricPer:'/lot', metric2:'TMGM Standard · Gold rebate', metric3:'added spread markup',
    ...
    rebateTitle:'What is a rebate?', rebateDesc:'You trade normally. The platform may pay commission to a referral channel, and Max Rebate returns the eligible rebate portion to you.', story1t:'Trade as usual', story1d:'Same account, platform and order process.', story2t:'Eligible rebate is generated', story2d:'Calculated from account group and eligible trading records.', story3t:'Rebate comes back to you', story3d:'We do not take an extra cut from the returnable portion.',
  ...
  const ZH = {
    ...EN,
    brandSub:'满返网', apply:'提交申请', navRebate:'什么是返佣', navPlatforms:'合作平台', navRates:'返佣标准', navCalc:'计算器', navContact:'联系', tickerTitle:'每日 Top IB', tickerNote:'历史返佣表现', heroKicker:'INDEPENDENT REBATE SERVICE', heroTitle:'交易照常，\n返佣回来。', heroDesc:'满返网收到的合资格返佣 100% 返还给客户。不额外克扣，不额外加点差；交易条件维持原样，交易者额外获得返现，我们致力于最大程度优化大家的交易成本。', viewRates:'查看返佣标准', applyNow:'立即申请', metric1:'返还我们收到的合资格返佣，不额外抽成', metricPer:'/手', metric2:'TMGM 标准账户 · 黄金返佣', metric3:'额外点差加价',
    ...
    rebateTitle:'什么是返佣？', rebateDesc:'你正常交易，平台向合作渠道支付一部分佣金；满返网再把符合条件的返佣返还给你。', story1t:'你正常交易', story1d:'账户、平台、下单方式照常。', story2t:'产生合资格返佣', story2d:'平台按账户组别与有效交易记录计算。', story3t:'返佣回到你', story3d:'我们不额外克扣可返还部分。',
  ...
  const ZHT = {
    ...EN,
    brandSub:'滿返網', apply:'提交申請', navRebate:'甚麼是返佣', navPlatforms:'合作平台', navRates:'返佣標準', navCalc:'計算器', navContact:'聯絡', tickerTitle:'每日 Top IB', tickerNote:'歷史返佣表現', heroTitle:'交易照常，\n返佣回來。', heroDesc:'滿返網收到的合資格返佣 100% 返還給客戶。不額外克扣，不額外加點差；交易條件維持原樣，交易者額外獲得返現，我們致力於最大程度優化交易成本。', viewRates:'查看返佣標準', applyNow:'立即申請', metric1:'返還我們收到的合資格返佣，不額外抽成', metricPer:'/手', metric2:'TMGM 標準帳戶 · 黃金返佣', metric3:'額外點差加價',
    whoTitle:'我們是誰？', whoDesc:'我們不是交易平台。我們讓返佣更透明地回到交易者手中。', missionTitle:'使命', missionText:'減少中間成本，讓返佣結構更透明。', taskTitle:'任務', taskText:'把合資格返佣 100% 返還給客戶。', serviceTitle:'服務', serviceText:'申請、資格核對與後續跟進。', aboutLink:'了解滿返網 →', rebateTitle:'甚麼是返佣？', rebateDesc:'你正常交易，平台向合作渠道支付佣金；滿返網把符合條件的返佣返還給你。', story1t:'正常交易', story1d:'帳戶、平台及下單方式照常。', story2t:'產生合資格返佣', story2d:'按帳戶組別及有效交易記錄計算。', story3t:'返佣回到你', story3d:'不額外克扣可返還部分。',
